        ...
        return (
            <div className="container mx-auto p-6">
                <div className="text-center">
                    <h1 className="text-2xl font-bold text-red-600 mb-4">Error Loading Groups</h1>
        ...
        <div className="container mx-auto p-6 space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-600">Organize agents into groups for easier management</p>
                </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        All agent groups and their details
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    {groups.length === 0 ? (
