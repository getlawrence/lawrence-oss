...
export default function ConfigsPage() {
    ...
    const { data: configsData, error: configsError, mutate: mutateConfigs } = useSWR(
        'configs',
        () => getConfigs({ limit: 100 }),
        ...
        return (
            <div className="container mx-auto p-6">
                <div className="text-center">
                    <h1 className="text-2xl font-bold text-red-600 mb-4">Error Loading Configs</h1>
        ...
        <div className="container mx-auto p-6 space-y-6">
                    ...
                    <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
                        ...
                        <DialogContent className="max-w-2xl">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setCreateForm({ ...createForm, config_hash: e.target.value })}
                            ...
                            <DialogFooter>
                                ...
                                <Button onClick={handleCreateConfig} disabled={!createForm.content}>
                                    Create Config
                                </Button>
                            </DialogFooter>
                        </DialogContent>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        All agent and group configurations
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    {configs.length === 0 ? (
                            ...
                            <TableBody>
                                {configs.map((config: Config) => (
                                    <TableRow key={config.id}>
                                        <TableCell className="font-mono text-sm">{config.id.slice(0, 8)}...</TableCell>
                                        <TableCell>
                                            {config.agent_id ? (
                                                <span className="text-blue-600">Agent: {config.agent_id.slice(0, 8)}...</span>
                                            ) : config.group_id ? (
