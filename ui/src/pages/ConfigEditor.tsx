      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">
            Create and manage OpenTelemetry collector configurations
          </p>
        </div>
              ...
              <div className="space-y-2 max-h-96 overflow-y-auto">
                ...
                {versions.length === 0 && (
                  <div className="text-center py-8 text-gray-500">
                    No version history available. Select a group to view
                    versions.
                  </div>
                )}
              </div>
        ...
        <CardContent className="space-y-4">
          ...
          {selectedConfig && (
            <Alert>
              ...
              <AlertDescription>
                Editing config version {selectedConfig.version} - Saving will
                create version {selectedConfig.version + 1}
              </AlertDescription>
            </Alert>
          )}
        </CardContent>
